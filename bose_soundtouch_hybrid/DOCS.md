...
- Leave `Music Assistant IP address` blank when Music Assistant runs as a Home Assistant app on the same host. Set it when Music Assistant runs elsewhere, such as Docker.
...
The build currently fetches: v3.6.7
