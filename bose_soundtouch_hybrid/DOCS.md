...
- Music Assistant API control uses `Music Assistant port`. Keep `Music Assistant login required` enabled and set username/password when the Music Assistant API requires login.
